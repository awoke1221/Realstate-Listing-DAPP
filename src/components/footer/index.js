...
const navlinks = ["Home", 'Listing', 'Items', 'Account'];

export default function Footer() {
    return (
        <div className=' bg-[#f9f1f1eb] w-full absolute z-10'>
            <footer className=" font-mono grid justify-stretch gap-9 w-full px-4 py-8 md:px-6 md:py-[50px] xl:px-10">
                ...
                <div className=' grid grid-cols-2 justify-items-start md:justify-items-center gap-y-8 md:gap-y-20 md:max-xl:gap-x-20 xl:flex xl:justify-between text-[20px] xl:px-[178.5px]'>
                    ...
                    <div className='flex flex-col max-md:justify-self-end'>
                        ...
                        <div className='grid gap-y-4 md:gap-y-6'>
                            <a href='https://github.com/awoke1221' target='_blank'>GitHub</a>
                        </div>
                    </div>
                    ...
                    <div className='flex flex-col max-md:justify-self-end'>
                        ...
                        <div className='grid gap-y-4 md:gap-y-6'>
                            <a href='https://www.youtube.com/@awokezemenu' target='_blank'>YouTube</a>                           
                        </div>
                    </div>
                </div>
